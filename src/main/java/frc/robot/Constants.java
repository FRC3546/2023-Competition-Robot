...
public final class Constants {
  ...
  public static final double DRIVETRAIN_TRACKWIDTH_METERS =  0.55245; // FIXME Measure and set trackwidth
  /**
   * The front-to-back distance between the drivetrain wheels.
   *
   * Should be measured from center to center.
   */
  public static final double DRIVETRAIN_WHEELBASE_METERS = 0.67945; // FIXME Measure and set wheelbase
  ...
  public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 22; // FIXME Set front right drive motor ID
  public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 23; // FIXME Set front right steer motor ID
  ...
  public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 24; // FIXME Set back left drive motor ID
  public static final int BACK_LEFT_MODULE_STEER_MOTOR = 25; // FIXME Set back left steer motor ID
  ...
  public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 26; // FIXME Set back right drive motor ID
  public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 27; // FIXME Set back right steer motor ID
